...
OUT = BASE / "snowballing" / "round-2" / "acquisition-summary.md"
RUN_LOCAL = "2026-05-28 13:32"
...
def main() -> None:
    ...
    snow = [
        ...
        if (entry.get("systematic_review") or {}).get("discovery") == "snowballing-2"
    ...
    lines = [
        "# Acquisition Snowballing Round 2",
        "",
        f"> Executado em: {RUN_LOCAL}",
        "> Escopo: `snowballing-2` incluidos apos screening por titulo e abstract",
        "",
        "## Resultado",
        "",
