...
> **Score atual (Q): 87 / 100.** (era 74; scientex-improve 2026-05-30/31, com texto completo + busca suplementar + expansão do corpus 37->41) **Teto honesto desta rodada ~87.** **Meta 90+ exige itens AUTOR: IRR humano real (kappa), expansão completa do corpus (7 estudos pós-corte + mais bases) e/ou um segundo avaliador humano.**
...
| Generalização | 10 | 6 | 9 | IMP-5 saturação honesta + IMP-7 viés quantificado (28/41) + busca suplementar real que EXPANDIU o corpus de 37 para 41 (4 estudos peer-reviewed de 2025 incorporados; 7 pós-corte e 1 pendente documentados). Corpus maior, mais venues e auditoria de completude transparente. Para 10: incorporar os 7 pós-corte e ampliar bases (AUTOR). |
| **Total** | **100** | **74** | **87** | deltas confirmados por re-crítica independente (paper-critic, ciclos 4 e 5); IMP-4 completo (texto completo) e corpus expandido 37->41 com consistência numérica verificada nas duas línguas. Sem fabricação; sem regressão de forças. |
...
### IMP-7 (MÉDIO) Ampliar bases/idiomas ou justificar o recorte [FEITO 2026-05-31: viés quantificado (28/41) + busca suplementar real (run_supplementary_search.py) que EXPANDIU o corpus de 37 para 41 (4 estudos peer-reviewed de 2025 incorporados: Tawosi2025, Erten2025, Zabardast2025, Chen2025, extração a nível de resumo/confiança média; +5 refs DOI no bib; figuras e contagens recomputadas). 7 estudos pós-corte e 1 pendente documentados em screened-inscope.md para atualização futura. Incorporar os 7 pós-corte + mais bases fica PENDENTE-AUTOR]
...
| 2026-05-31 | 87 | Expansão do corpus autorizada pelo autor: 4 estudos peer-reviewed de 2025 da busca suplementar incorporados (corpus 37->41: Tawosi2025/ALMAS, Erten2025/Scrum-AI, Zabardast2025/3-Layer NFR, Chen2025/AutoReview; extração a nível de resumo/confiança média; +4 refs com DOI verificado no CrossRef). Figuras (funil, saturação, dados, qualidade) e TODAS as contagens recomputadas e propagadas nas duas línguas (framework 37, empírica 28, peer-reviewed 29, caso 6, segurança 26, 2025:15). Generalização 8->9. Consistência numérica e ausência de regressão confirmadas por re-crítica (paper-critic ciclo 5). latex-validator 0 fatais pt+en; 44/44 cite-keys; 0 travessão. 1 estudo da janela e 7 pós-corte ficam documentados para atualização futura (AUTOR). |
